...
<html>
   ...
   <body class="is-preload">
                  ...
                  <div class="inner">
                     ...
                     <section class="main accent2" style="padding:3%">
                        ...
                        <form method="post" action="#" class="combined" style="width:auto;">
                           <textarea name="content" placeholder="비속어를 사용하지 말아주세요." class="invert" rows="5" style="border-radius:0; resize:none;"></textarea>
      ...
      <!-- Scripts -->
          <script>let boardNumber = "${board.getBoardNumber()}";</script>
